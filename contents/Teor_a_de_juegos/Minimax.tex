\subsubsection{\textit{Minimax}}
  ...
  \begin{definition}[\textbf{Valor \textit{Maximin}}]
    ...
    obtener un jugador, sin conocer las jugadas de su oponente. \ab{De donde viene esta formalismo? Es importante mencionarlo}
    ...
    \begin{itemize}
      ...
      \item \(-i\) representa a todos los jugadores oponentes. \ab{tenemos $-\text{i} \implies \text{j}\in\cal{J} \land \text{j} \neq \text{i}$ ?}
...
\ab{Lo que significa? Puedes detallar $\underline{v_{i}}$?}
  ...
  \begin{definition}
    ...
    \[
      ...
      \end{cases}  
    \]
    Con \(F\) representando el estado final del juego. \ab{A que corresponde MM?}
  \end{definition}
